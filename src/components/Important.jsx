import IconFire from '../assets/icon-fire';
import IconKnife from '../assets/icon-knife';
import IconQuestion from '../assets/icon-question';
import IconShield from '../assets/icon-shield';
import backgroundImageUrl from '../assets/background-important.webp';

const Important = () => {
	return (
		<section id='important'>
			<h3 className='text-3xl font-semibold text-center text-black sm:mb-14 mb-8 sm:text-5xl lg:text-7xl w-[80vw] mx-auto'>
			...
			<div
				className='h-[140px] bg-cover bg-center max-w-7xl md:min-h-[450px] mb-11 mx-auto'
